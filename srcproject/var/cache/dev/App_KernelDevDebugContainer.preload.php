...
require __DIR__.'/Container4TFvSAu/App_KernelDevDebugContainer.php';
require __DIR__.'/Container4TFvSAu/getWebProfiler_Controller_RouterService.php';
require __DIR__.'/Container4TFvSAu/getWebProfiler_Controller_ProfilerService.php';
require __DIR__.'/Container4TFvSAu/getWebProfiler_Controller_ExceptionPanelService.php';
require __DIR__.'/Container4TFvSAu/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/Container4TFvSAu/getValidator_ExpressionService.php';
require __DIR__.'/Container4TFvSAu/getValidator_EmailService.php';
require __DIR__.'/Container4TFvSAu/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/Container4TFvSAu/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/Container4TFvSAu/getTwig_Mailer_MessageListenerService.php';
require __DIR__.'/Container4TFvSAu/getTwig_Form_RendererService.php';
require __DIR__.'/Container4TFvSAu/getTranslation_Loader_YmlService.php';
require __DIR__.'/Container4TFvSAu/getTranslation_Loader_XliffService.php';
require __DIR__.'/Container4TFvSAu/getTranslation_Loader_ResService.php';
require __DIR__.'/Container4TFvSAu/getTranslation_Loader_QtService.php';
require __DIR__.'/Container4TFvSAu/getTranslation_Loader_PoService.php';
require __DIR__.'/Container4TFvSAu/getTranslation_Loader_PhpService.php';
require __DIR__.'/Container4TFvSAu/getTranslation_Loader_MoService.php';
require __DIR__.'/Container4TFvSAu/getTranslation_Loader_JsonService.php';
require __DIR__.'/Container4TFvSAu/getTranslation_Loader_IniService.php';
require __DIR__.'/Container4TFvSAu/getTranslation_Loader_DatService.php';
require __DIR__.'/Container4TFvSAu/getTranslation_Loader_CsvService.php';
require __DIR__.'/Container4TFvSAu/getSession_Storage_NativeService.php';
require __DIR__.'/Container4TFvSAu/getSessionService.php';
require __DIR__.'/Container4TFvSAu/getServicesResetterService.php';
require __DIR__.'/Container4TFvSAu/getSerializer_Mapping_CacheClassMetadataFactoryService.php';
require __DIR__.'/Container4TFvSAu/getSerializerService.php';
require __DIR__.'/Container4TFvSAu/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/Container4TFvSAu/getSecurity_PasswordEncoderService.php';
require __DIR__.'/Container4TFvSAu/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/Container4TFvSAu/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/Container4TFvSAu/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/Container4TFvSAu/getSecurity_Csrf_TokenStorageService.php';
require __DIR__.'/Container4TFvSAu/getSecurity_Csrf_TokenManagerService.php';
require __DIR__.'/Container4TFvSAu/getSecurity_ContextListener_0Service.php';
require __DIR__.'/Container4TFvSAu/getSecurity_ChannelListenerService.php';
require __DIR__.'/Container4TFvSAu/getSecurity_AuthenticationUtilsService.php';
require __DIR__.'/Container4TFvSAu/getSecurity_Authentication_Listener_Anonymous_MainService.php';
require __DIR__.'/Container4TFvSAu/getSecurity_AccessListenerService.php';
require __DIR__.'/Container4TFvSAu/getSecrets_VaultService.php';
require __DIR__.'/Container4TFvSAu/getRouting_LoaderService.php';
require __DIR__.'/Container4TFvSAu/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/Container4TFvSAu/getPropertyAccessorService.php';
require __DIR__.'/Container4TFvSAu/getMonolog_Logger_SecurityService.php';
require __DIR__.'/Container4TFvSAu/getMimeTypesService.php';
require __DIR__.'/Container4TFvSAu/getFragment_Renderer_InlineService.php';
require __DIR__.'/Container4TFvSAu/getForm_TypeGuesser_ValidatorService.php';
require __DIR__.'/Container4TFvSAu/getForm_TypeGuesser_DoctrineService.php';
require __DIR__.'/Container4TFvSAu/getForm_TypeExtension_Upload_ValidatorService.php';
require __DIR__.'/Container4TFvSAu/getForm_TypeExtension_Form_ValidatorService.php';
require __DIR__.'/Container4TFvSAu/getForm_TypeExtension_Form_TransformationFailureHandlingService.php';
require __DIR__.'/Container4TFvSAu/getForm_TypeExtension_Form_HttpFoundationService.php';
require __DIR__.'/Container4TFvSAu/getForm_TypeExtension_Form_DataCollectorService.php';
require __DIR__.'/Container4TFvSAu/getForm_TypeExtension_CsrfService.php';
require __DIR__.'/Container4TFvSAu/getForm_Type_FormService.php';
require __DIR__.'/Container4TFvSAu/getForm_Type_FileService.php';
require __DIR__.'/Container4TFvSAu/getForm_Type_EntityService.php';
require __DIR__.'/Container4TFvSAu/getForm_Type_ColorService.php';
require __DIR__.'/Container4TFvSAu/getForm_Type_ChoiceService.php';
require __DIR__.'/Container4TFvSAu/getForm_ServerParamsService.php';
require __DIR__.'/Container4TFvSAu/getForm_RegistryService.php';
require __DIR__.'/Container4TFvSAu/getForm_FactoryService.php';
require __DIR__.'/Container4TFvSAu/getForm_ChoiceListFactory_CachedService.php';
require __DIR__.'/Container4TFvSAu/getFilesystemService.php';
require __DIR__.'/Container4TFvSAu/getErrorHandler_ErrorRenderer_HtmlService.php';
require __DIR__.'/Container4TFvSAu/getErrorControllerService.php';
require __DIR__.'/Container4TFvSAu/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/Container4TFvSAu/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/Container4TFvSAu/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/Container4TFvSAu/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/Container4TFvSAu/getDebug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/Container4TFvSAu/getDebug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/Container4TFvSAu/getDebug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
require __DIR__.'/Container4TFvSAu/getDebug_Security_UserValueResolverService.php';
require __DIR__.'/Container4TFvSAu/getDebug_FileLinkFormatter_UrlFormatService.php';
require __DIR__.'/Container4TFvSAu/getDebug_ArgumentResolver_VariadicService.php';
require __DIR__.'/Container4TFvSAu/getDebug_ArgumentResolver_SessionService.php';
require __DIR__.'/Container4TFvSAu/getDebug_ArgumentResolver_ServiceService.php';
require __DIR__.'/Container4TFvSAu/getDebug_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/Container4TFvSAu/getDebug_ArgumentResolver_RequestService.php';
require __DIR__.'/Container4TFvSAu/getDebug_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/Container4TFvSAu/getDebug_ArgumentResolver_DefaultService.php';
require __DIR__.'/Container4TFvSAu/getContainer_GetenvService.php';
require __DIR__.'/Container4TFvSAu/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/Container4TFvSAu/getContainer_EnvVarProcessorService.php';
require __DIR__.'/Container4TFvSAu/getCacheClearerService.php';
require __DIR__.'/Container4TFvSAu/getCache_SystemClearerService.php';
require __DIR__.'/Container4TFvSAu/getCache_GlobalClearerService.php';
require __DIR__.'/Container4TFvSAu/getCache_AppClearerService.php';
require __DIR__.'/Container4TFvSAu/getAnnotations_CacheService.php';
require __DIR__.'/Container4TFvSAu/getTemplateControllerService.php';
require __DIR__.'/Container4TFvSAu/getRedirectControllerService.php';
require __DIR__.'/Container4TFvSAu/getBlogControllerService.php';
require __DIR__.'/Container4TFvSAu/get_ServiceLocator_IEz6L2DService.php';
require __DIR__.'/Container4TFvSAu/get_ServiceLocator_Beq5mCoService.php';
require __DIR__.'/Container4TFvSAu/get_ServiceLocator_C9JCBPCService.php';
